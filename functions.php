...
function rookie_widgets_init() {
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget main-navigation comunidades-e-sportspy %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget main-navigation banner-izquierda %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	) );
	register_sidebar( array(
		...
		'id'            => 'sponsors-derecha',
		'description'   => 'Para las plantillas (Comunidades, Torneos)',
		'before_widget' => '<aside id="%1$s" class="widget main-navigation sponsors-derecha %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	) );
